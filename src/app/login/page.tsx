  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6 py-12 relative">
      ...
      <div className="fixed inset-0 -z-10 overflow-hidden">
        <div className="absolute -top-40 -right-40 w-[500px] h-[500px] bg-brand-200/25 rounded-full blur-3xl" />
        <div className="absolute bottom-0 -left-40 w-[400px] h-[400px] bg-mint-200/20 rounded-full blur-3xl" />
      </div>
